...
| クロストラックスナップ | 2026-01-31 | 音声クリップも全トラックの境界にスナップ |
| 画像サムネイルFILL | 2026-01-31 | クリップ幅全体にタイル表示（VideoClipThumbnailsと同様） |
| 図形サムネイル改善 | 2026-01-31 | アスペクト比維持、クリップ幅超過防止 |
| ボリュームエンベロープ | 2026-01-31 | 音声キーフレーム編集（追加/削除/ドラッグ）、プレビュー反映 |
| AI複数プロバイダー対応 | 2026-01-31 | OpenAI (GPT-4o) / Gemini / Anthropic Claude 選択可能 |
| クリップ名ツールチップ | 2026-01-31 | 映像クリップにtitle属性、マウスオーバーで表示維持 |
| 図形に名前プロパティ | 2026-01-31 | Shape.name追加、クリップ表示名に反映 |
